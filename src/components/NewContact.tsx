...
const schema = yup
  .object({
    ...
    telephone: yup.string().matches(phoneRegExp, 'Phone number is not valid').required(),
  })
  .required();
      ...
      <div className="bg-white  p-4 px-4 text-sm ">
        ...
        <div className="mt-3 text-right">
          <div className="inline-flex items-end">
            <button
              type="submit"
              className="flex items-center bg-indigo-500 text-white hover:bg-purple-500 p-2 rounded text-sm w-auto"
